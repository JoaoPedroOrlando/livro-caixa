...
import {
  formatNumberToCurrencyStr,
  formatStringToCurrencyStr,
...
function EntryScreen({ navigation, route }): JSX.Element {
  ...
  const [updateOperationId, setUpdateOperationId] = useState<number | null>(
    null
  );
  //------------------------------------------------------------
  //inputs------------------------------------------------------
  ...
  const updateCashbookAfterSelection = async (
    cashbook: Cashbook
  ): Promise<void> => {
    try {
          ...
          <InputsContainer>
            {cashbook ? (
              <Row>
                ...
                <ChangeCashbookBtn onPress={navigateToSelectionCashbook}>
                  <Icon
            ...
            >
              <View>
                <DateBtn onPress={showDatepicker}>
                  <TextStyled>{formatDate(date)}</TextStyled>
                </DateBtn>
              </View>
              <RadioButton.Group onValueChange={onChangeType} value={type}>
                <RadioGroupContainer>
                  ...
                  <RadioContainer>
                    ...
                    <RadioButton
                      value={EntryTypeEnum.OUTFLOW}
                      color={Colors.primary.gray}
                    />
                  </RadioContainer>
                </RadioGroupContainer>
              </RadioButton.Group>
              <AddBtn onPress={onSaveEntry}>
                <Icon
                  name="add"
                  type="ionicon"
