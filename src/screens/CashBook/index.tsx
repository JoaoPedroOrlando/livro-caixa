  ...
  return (
    <TouchableWithoutFeedback onPress={dismissKeyboard}>
      <Container>
        ...
        >
          <SheetContainer>
            <WarnningText>{t("want-to-delete")}</WarnningText>
            <Spacer />
            <Row style={{ justifyContent: "center" }}>
              <DeleteBtn onPress={handleDelete}>
                <DeleteBtnText>{t("delete")}</DeleteBtnText>
              </DeleteBtn>
            </Row>
          </SheetContainer>
        </BottomSheet>
